...
# Created by Umbaa. 2022-08-22

from email.policy import default
from odoo import api, fields, models

class GmailReadList(models.Model):
    _inherit = "mail.mail"
    
    # _description = "Gmail integration"

    # to_mail = fields.Char(string="To mail")
    # from_mail = fields.Char(string="From mail")
    # mail_subject = fields.Char(string="Mail Subject")
    # mail_data = fields.Char(string="Mail")

    is_gmail = fields.Boolean(string="Check in Gmail", readonly=False, default = True)

    gmail_profile_img = fields.Char(string="Gmail Profile Image path")
    gmail_profile_name = fields.Char(string="Gmail Profile Name")
    gmail_date = fields.Datetime(string="Gmail date")

    is_read = fields.Boolean(string="Mail read", readonly=False,)

    # available_user_ids = fields.Many2many(
    #     comodel_name="res.users",s
