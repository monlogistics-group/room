odoo.define('ml_worldwide-main.pivot_renderer_extension', function (require) {
    "use strict";

    var PivotRenderer = require('web.PivotRenderer');
    
    console.log("pivot_renderer_extension");

    var CustomPivotRenderer = PivotRenderer.extend({
        renderButtons: function ($node) {
            ...
            $node.appendTo($button);
        },
        // override the renderCell method to add a custom background color
        renderCell: function ($cell, node) {
            this._super($cell, node);
            // add a custom background color to the cell
            $cell.css('background-color', '#FF00FF');
        },
    });

    return CustomPivotRenderer;
});

// odoo.define('ml_worldwide-main.pivot_renderer', function (require) {
//     "use strict";
...
//             console.log("SSSSSSSSSSSSSSSSSSSSSS ",index);
//             if (value != 'undefined'){
